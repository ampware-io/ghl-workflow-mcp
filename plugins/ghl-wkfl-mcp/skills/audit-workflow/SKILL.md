...
Audit is diagnostic. Do not call `update_workflow` or `publish_workflow` as part of the audit flow — the user must decide which replacements to apply. Offer to run the `start_edit_workflow` flow next if they want help applying the fixes.
