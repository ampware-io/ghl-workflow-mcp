...
server binary itself is distributed separately via GitHub Releases on the
source repo: https://github.com/ampware-io/ghl-workflow-mcp/releases

## Install (two steps)

1. Install the `ghl-wkfl-mcp` binary and put it on your PATH:
   - Download the binary for your platform from
     https://github.com/ampware-io/ghl-workflow-mcp/releases
...
See the full docs at https://github.com/ampware-io/ghl-workflow-mcp
